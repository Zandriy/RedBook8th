...
Ex08_16::Ex08_16()
	: OGLWindow("Example08_16", "Example 8.16 (M)")
{
}
...
void Ex08_16::InitGL()
{
	...
	ShaderInfo  object_shaders[] = {
		...
		{ GL_FRAGMENT_SHADER, "Shaders/sh08_16.frag" },
		{ GL_NONE, NULL }
	};
	...
	GLuint LightPosition_loc = glGetUniformLocation(object_prog, "LightPosition");
 	...
 	GLuint SkyColor_loc = glGetUniformLocation(object_prog, "SkyColor");
 	GLuint CloudColor_loc = glGetUniformLocation(object_prog, "CloudColor");
	...
	glUniform3fv(SkyColor_loc, 1, vmath::vec3(0.0f, 0.0f, 0.8f));
	glUniform3fv(CloudColor_loc, 1, vmath::vec3(0.8f, 0.8f, 0.8f));
...
void Ex08_16::make3DNoiseTexture()
{
	int f, i, j, k, inc;
...
double Ex08_16::noise3(double *ni)
{
	const int i = 12;
	static int c = 0;
	static int cur = 0;
