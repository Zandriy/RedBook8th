...
Ex07_04::Ex07_04()
	: OGLWindow("Example07_04", "Example 7.4 (M)")
{
}
...
void Ex07_04::InitGL()
{
	...
	ShaderInfo  object_shaders[] = {
		{ GL_VERTEX_SHADER, "Shaders/sh07_04.vert" },
		{ GL_FRAGMENT_SHADER, "Shaders/sh07_04.frag" },
		{ GL_NONE, NULL }
	};
...
void Ex07_04::keyboard( unsigned char key, int x, int y )
{
	switch( key ) {
	case 'M': 
