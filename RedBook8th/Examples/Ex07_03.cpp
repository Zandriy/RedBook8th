...
void Ex07_03::InitGL()
{
	...
	object_mat_mv_loc = glGetUniformLocation(object_prog, "NormalMatrix");
	...
	glUniform4fv(object_color_loc, 1, vmath::vec4(1.0f, 0.5f, 0.5f, 0.5f));
	...
	glUniform3fv(object_LightDirection_loc, 1, vmath::vec3(0.0f, 0.0f, 1.0f));
