...
Ex07_06::Ex07_06()
	: OGLWindow("Example07_06", "Example 7.6 (M)")
{
}
...
void Ex07_06::InitGL()
{
	...
	ShaderInfo  object_shaders[] = {
		{ GL_VERTEX_SHADER, "Shaders/sh07_06.vert" },
		{ GL_FRAGMENT_SHADER, "Shaders/sh07_06.frag" },
		{ GL_NONE, NULL }
	};
...
void Ex07_06::keyboard( unsigned char key, int x, int y )
{
	switch( key ) {
	case 'M': 
