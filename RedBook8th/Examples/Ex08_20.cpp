...
Ex08_20::Ex08_20()
	: OGLWindow("Example08_20", "Example 8.20 (M)")
{
}
...
void Ex08_20::InitGL()
{
	...
	ShaderInfo  object_shaders[] = {
		...
		{ GL_FRAGMENT_SHADER, "Shaders/sh08_20.frag" },
		{ GL_NONE, NULL }
	};
...
void Ex08_20::keyboard( unsigned char key, int x, int y )
{
	switch( key ) {
	case 'M': 
...
void Ex08_20::make3DNoiseTexture()
{
	int f, i, j, k, inc;
...
double Ex08_20::noise3(double *ni)
{
	const int i = 12;
	static int c = 0;
	static int cur = 0;
