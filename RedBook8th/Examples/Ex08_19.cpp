...
Ex08_19::Ex08_19()
	: OGLWindow("Example08_19", "Example 8.19 (M)")
{
}
...
void Ex08_19::InitGL()
{
	...
	ShaderInfo  object_shaders[] = {
		...
		{ GL_FRAGMENT_SHADER, "Shaders/sh08_19.frag" },
		{ GL_NONE, NULL }
	};
	...
	GLuint LightPosition_loc = glGetUniformLocation(object_prog, "LightPosition");
 	...
 	GLuint MarbleColor_loc = glGetUniformLocation(object_prog, "MarbleColor");
 	GLuint VeinColor_loc = glGetUniformLocation(object_prog, "VeinColor");
	...
	glUniform3fv(MarbleColor_loc, 1, vmath::vec3(0.3f, 0.3f, 0.5f));
	glUniform3fv(VeinColor_loc, 1, vmath::vec3(0.8f, 0.8f, 0.8f));
...
void Ex08_19::keyboard( unsigned char key, int x, int y )
{
	switch( key ) {
	case 'M': 
...
void Ex08_19::make3DNoiseTexture()
{
	int f, i, j, k, inc;
...
double Ex08_19::noise3(double *ni)
{
	const int i = 12;
	static int c = 0;
	static int cur = 0;
