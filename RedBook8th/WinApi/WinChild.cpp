...
WinChild::WinChild(const char* name, const char* title)
	: m_ClassName(name)
	, m_WindowTitle(title)
	, m_hWnd(NULL)
	, m_hDC(NULL)
...
HWND WinChild::Init(HINSTANCE hInstance, HWND hParent)
{
...
BOOL WinChild::InitWindowClass(HINSTANCE hInstance)
{
	WNDCLASSEX wcx; 
...
HWND WinChild::InitInstance(HINSTANCE hInstance, HWND hParent)
{
...
void WinChild::MoveAndUpdate(int x, int y, int w, int h, int nCmdShow)
{
